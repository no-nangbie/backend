...
-- menu 테이블에 데이터 삽입
INSERT INTO menu (menu_title, menu_description, menu_category, recipes, cooking_time, serving_size, difficulty, image_url, menu_like_count, created_at, modified_at)
VALUES
    ('떡볶이',
...
INSERT INTO food_menu (food_quantity, food_id, menu_id) VALUES
                                                            ('800g', 20, 1), -- 떡 800g
                                                            ('160g', 9, 1),  -- 어묵 160g
                                                            ('160g', 6, 1),  -- 양배추 160g
                                                            ('240g', 1, 1),  -- 대파 240g
